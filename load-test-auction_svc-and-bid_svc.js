...
const users = new SharedArray('users', () => [1, 2, 3, 4, 5]); // Replace with actual User IDs
const cars = new SharedArray('cars', () => [101, 102, 103, 104, 105]); // Replace with actual Car IDs
...
function createAuction() {
    ...
    const res = http.post(`${BASE_URL}/auctions/create`, payload, { headers });
...
function submitBid(auctionId) {
    ...
    const headers = { 'Content-Type': 'application/json' };
    const res = http.post(`${BASE_URL}/bids/create`, payload, { headers });
